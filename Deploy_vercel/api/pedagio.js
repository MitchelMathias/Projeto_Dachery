const { BrowserPool } = require('@crawlee/browser-pool');
...
module.exports = async (req, res) => {
    ...
    try {
        browserController = await browserPool.newPage();
        ...
        await browserPool.destroy();
        res.status(500).json({ error: err.stack || err.message || 'Erro desconhecido' });
    }
};
